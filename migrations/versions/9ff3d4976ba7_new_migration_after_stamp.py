...
def upgrade():
    ...
    # Commented out creating admin table since it already exists
    ...
    with op.batch_alter_table('student_registration', schema=None) as batch_op:
        ...
        # Column 'created_at' does not exist in prod, so skip dropping
    ...
    with op.batch_alter_table('tuition_requirement', schema=None) as batch_op:
        ...
        # 'pdf_filename' column missing in prod, so skip dropping
    ...
    with op.batch_alter_table('tutor_registration', schema=None) as batch_op:
        ...
        batch_op.alter_column('password_hash',
               ...
               type_=sa.String(length=256),
               existing_nullable=False)
        # 'created_at' column missing, do not drop
        # batch_op.drop_column('created_at')
...
def downgrade():
    # Upgrade comments removed (usually you may keep downgrade for safety)
    with op.batch_alter_table('tutor_registration', schema=None) as batch_op:
    ...
    # Commented to prevent dropping admin table, which already exists
    # op.drop_table('admin')
    # ### end Alembic commands ###
